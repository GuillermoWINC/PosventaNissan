...
class AuthCreateUserWidget extends StatefulWidget {
  ...
  static String routeName = 'auth_CreateUser';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AssignmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AssignmentsRecord> authCreateUserAssignmentsRecordList =
            snapshot.data!;
                                            ...
                                            Padding(
                                              ...
                                              child:
                                                ...
                                                options: [
                                                  ...
                                                  'UNSAIN MOTOR, S.L.U.',
                                                  'VICAUTO, S.A.U.',
                                                  'TALLERES MECÁNICOS JOSÉ AMAT, S.L.',
                                                  'HIDECAR MELILLA, S.L.',
                                                  'HERMANOS MATEO LORENZO, S.A.',
                                                  'GUADALMOCIÓN, S.L.',
                                                  'GARATGE NOGREDA',
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                if (_model.userID2?.uid !=
                                                  ...
                                                  while (_model.loop <
                                                      valueOrDefault<int>(
                                                        authCreateUserAssignmentsRecordList
                                                            .length,
                                                        0,
                                                      )) {
                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text('Error'),
                                                          content: Text(
                                                              'No se han podido crear las tareas para este usuario. Por favor, bórralo y vuelve a intentar crearlo.'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
