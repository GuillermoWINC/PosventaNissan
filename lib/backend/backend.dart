...
/// Functions to query UserDoneRecords (as a Stream and as a Future).
Future<int> queryUserDoneRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserDoneRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserDoneRecord>> queryUserDoneRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UserDoneRecord.collection,
      UserDoneRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserDoneRecord>> queryUserDoneRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
