...
class UploadDocumentationWidget extends StatefulWidget {
  const UploadDocumentationWidget({
    super.key,
  ...
  @override
  State<UploadDocumentationWidget> createState() =>
      _UploadDocumentationWidgetState();
}

class _UploadDocumentationWidgetState extends State<UploadDocumentationWidget>
    with TickerProviderStateMixin {
  late UploadDocumentationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadDocumentationModel());
