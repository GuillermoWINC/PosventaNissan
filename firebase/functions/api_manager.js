...
async function _emailResendCall(context, ffVariables) {
  ...
  var headers = {
    Authorization: `Bearer re_S8hwHGkv_DYC5ifbyRrfygMKuCcjj4dXE`,
  };
  var params = {};
  var ffApiRequestBody = `
{
  "from": "Venta Exterior Nissan <winc@winc.es>",
  "to":${toEmail},
...
async function makeApiCall(context, data) {
  ...
  const callMap = {
    EmailResendCall: _emailResendCall,
  };
