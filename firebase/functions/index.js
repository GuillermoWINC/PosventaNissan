...
exports.emailAPIcall = functions
  .region("europe-central2")
  .runWith({ minInstances: 1, maxInstances: 1, timeoutSeconds: 120 })
...
exports.emailAPIcallV2 = onRequest(
  { cors: true, minInstances: 1, maxInstances: 1, timeoutSeconds: 120 },
  async (req, res) => {
    try {
      const context = {
